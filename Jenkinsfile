    ...
    stages {
        ...
        stage('SonarQube Analysis') {
            steps {
                ...
                // Manually configure Sonarqube Server as 'sonarqube' at Jenkins dashboard
        ...
        stage('Download Artifact') {
            steps {
                script {
                    ...
                    def artifactUrl = "http://localhost:8080/job/petclinic_viz/6/artifact/target/spring-petclinic-3.1.0-SNAPSHOT.jar"
